...
## Resources
In the [paradigms](paradigms/) folder, 58 paradigms are provided in both `.xlxs` or `.tsv`. A [README](paradigms/README.md) file explains the organization of the paradigm files. The paradigms are provided in:
...
Transliterated versions of the data are also provided. They are transliterated based on the [transliteration key](transliteration.md).
